        ...
        <div class="glass-card" style="padding: 0; border: none; border-radius: var(--radius-md); overflow: hidden; position: relative; display: flex; flex-direction: column; background: var(--bg-deep); border: 1px solid var(--border);">
          ...
          <div style="padding: 20px; flex: 1; display: flex; flex-direction: column;">
            ...
            <p style="margin:0 0 10px 0; color:var(--text-muted); font-size:0.8rem; display: flex; align-items: center; gap: 4px;">
              <i class="ph ph-calendar"></i> Fecha de Inscripci�n: ${dateStr}
            </p>
...
window.openInfluencerModal = function() {
  const rules = (window.SITE_SETTINGS && window.SITE_SETTINGS.influencerRules) 
    ...
    : [
      'M�nimo 1,000 seguidores en tu red social principal.',
      'Contenido activo relacionado a videojuegos.',
      'Colocar tu link de referido en tu perfil/descripci�n.'
    ];
  ...
  Swal.fire({
    ...
    html: `
      <div style="text-align: left; font-size: 0.9rem; line-height: 1.5; color: var(--text-secondary);">
        <p style="margin-bottom: 15px;">Al convertirte en <strong>Influencer de AccessPlay</strong>, tu l�mite de referidos se ampliar� considerablemente, recibir�s una insignia VIP en tu perfil y podr�s monetizar a tu audiencia.</p>
        <p style="margin-bottom: 10px;"><strong>Normas b�sicas:</strong></p>
        ...
        <form id="influencer-app-form" style="display:flex; flex-direction:column; gap: 12px; margin-top: 10px;">
          ...
          <div>
            <label style="font-size: 0.75rem; color: var(--accent); font-weight: bold; margin-bottom: 4px; display: block;">�De qu� juegos creas contenido?</label>
          ...
          <div>
            <label style="font-size: 0.75rem; color: var(--accent); font-weight: bold; margin-bottom: 4px; display: block;">�Por qu� quieres ser Influencer?</label>
            <textarea id="inf-reason" class="admin-form-input" rows="3" placeholder="Cu�ntanos brevemente..." style="width:100%; padding: 10px; border-radius: 8px; border: 1px solid rgba(255,255,255,0.1); background: rgba(0,0,0,0.3); color: white; resize: none;" required></textarea>
          </div>
        </form>
      </div>
    `,
